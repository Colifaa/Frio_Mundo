    ...
    <div className="container">
      ...
      <div className="values-container">
        <VStack align="stretch">
          <Box p={4} bg="blue.400" color="white" rounded="md" className="fade-in-box">
        ...
        <VStack align="stretch">
          <Box p={4} bg="red.400" color="white" rounded="md" className="fade-in-box">
        ...
        <VStack align="stretch">
          <Box p={4} bg="gray.400" color="white" rounded="md" className="fade-in-box">
